...
// TAD: Lista CIRCULAR de elementos
struct Lista;
...
// Operacao de percurso circular na lista
void circula(const struct Lista* l, unsigned voltas);   // circula 'voltas' vezes pela lista
