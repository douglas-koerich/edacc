...
// TAD: Lista linear de elementos COM CABECALHO
struct Lista;
...
// Operacoes administrativas da lista
size_t tamanho(const struct Lista* l);  // devolve o tamanho da lista (em numero de elementos)
bool valida(const struct Lista* l);     // verifica integridade do conteudo da lista
